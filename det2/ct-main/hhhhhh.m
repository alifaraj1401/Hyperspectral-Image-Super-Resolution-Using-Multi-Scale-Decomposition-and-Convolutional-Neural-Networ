...
modelfile = 'CNNCTSRDETA.json';
weights = 'CNNCTSRDETA.h5';
netdetA = importKerasNetwork(modelfile,'WeightFile',weights,'OutputLayerType','regression')
modelfile = 'CNNCTSRDETB.json';
weights = 'CNNCTSRDETB.h5';
netdetB = importKerasNetwork(modelfile,'WeightFile',weights,'OutputLayerType','regression')
...
detA = double(activations(netdetA,coeffslr{2}/100,7));
detB = double(activations(netdetB,coeffslr{2}/100,7));
